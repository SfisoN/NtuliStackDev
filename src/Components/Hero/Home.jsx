      ...
      <div className="profile-component">
        <div class="profile-left">
          ...
          <p class="description">
            ...
            <span class="highlight"> Web Development</span>, with a strong focus
            on crafting clean, efficient, and scalable solutions. Passionate
        ...
        <div class="profile-right">
          ...
          <div class="social-icons">
            <a href="https://github.com/SfisoN">
              <i className="fab fa-github"></i>
            </a>
            <a href="https://www.linkedin.com/in/sifiso-ntuli-565b40298/">
              <i className="fab fa-linkedin"></i>
            </a>
            <a href="https://x.com/SNtuli53704">
